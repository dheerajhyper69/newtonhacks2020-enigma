      ...
      case 5:
        return (
          <div className="App">
            ...
            <p>
              The basics of the machine isn’t complicated, people have been using substitution ciphers since Ancient Rome. The Enigma was hard because of the randomness. Each rotor could be positioned in 26 different starting positions which changed daily. Doing some calculations (the work can be seen in the Research section), an Enigma has 158,962,555,217,826,360,000 initial start positions.
              <br />
